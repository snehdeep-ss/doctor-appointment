            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className='text__para text-[14px] md:text-[15px] leading-6 lg:max-w-[390px]'>
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit. Cupiditate minima at nulla libero eum adipisci.
                </p>

              </div>
            </div>

            <div className="mt-[50px] border-b border border-solid border-[#0066ff34]">
              <button
